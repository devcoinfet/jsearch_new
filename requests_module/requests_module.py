...
class CoreRequests():
    ...
    def test_connection(self):
        ...
        try:
            head_connection = requests.head(self.url,timeout=3,verify=False,data={'User-Agent': self.user_agent})
    ...
    def get_content_html(self):
        try:
            get_content = requests.get(self.url, timeout=3,data={'User-Agent': self.user_agent}, verify=False)
